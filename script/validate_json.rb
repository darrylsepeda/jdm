...
SupportedLanguageKeys = ["about", "difficulty", "difficulty_easy", "difficulty_hard", "difficulty_impossible",
                        ...
                        "extensionp3", "footer", "fork", "guide", "guideeasy", "guideexplanations", "guidehard",
                        "guideimpossible", "guidemedium", "hideinfo", "name", "noinfo", "noresults", "popular",
                        "reset", "sendmail", "showinfo", "tagline", "title", "twitter", "whatisthis", "whatisthis1",
                        "whatisthis2"]
...
def validate_language_key(keys_in_language_json, key, file)
    ...
    begin
        ...
        json.each_with_index do |(key, _), i|
            ...
            if is_sites_json
                ...
                validate_language_key(keys_in_language_json, key, file)
            end
